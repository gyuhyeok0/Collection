    ...
    public static void main(String[] args) {
        ...
        필기.
            ...
            필기.
                ...
                3. Map 인터페이스
            필기.
                List 인스테이스와 Set 인터페이스의 공통 부분을 Collection 인터페이스에서 정의하고 있다.
                하지만 Map은 구조상의 차이로 Collection 인터페이스에서 정의하고 있지 않다.
            필기.
                각 인터페이스 별 특징
                1. List 인터페이스
                - 순서있는 데이터의 집합으로 데이터 중복 저장을 허용한다.
                - Vector, *ArrayList, LinkedList, Stack, Queue 등이 있다.
                2. Set 인터페이스
                - 순서가 없는 데이터의 집합으로 데이터의 붕복을 허용하지 않는다.
                - *HashSet, TreeSet 등이 있다.
                3. Map 인터페이스
                - 키와 값 한쌍으로 이루어지는 데이터 집합이다.
            ...
            필기.
                ...
                배열의 단범 : 크기 변경 불가, 요소의 추가, 수정, 삭제, 정렬 등이 복잡함
                따라서 ArrayList 는 배열의 단점을 극복하고자
                크기변경( 새로운 더 큰 배열을 만들고 옮기기), 요소의 추가 수정 삭제 정렬 기능을
                미리 메소드로 구현하여 제공하고 있다.
     */

        ArrayList alist = new ArrayList();
        /* 필기.
            다형성을 적용하여 상위 래퍼런스로 ArrayList 객체를 만들 수 있다.
            List 인터페이스 하위의 다양한 구현체들로 타입 변경이 가능하기 때문에
            레퍼런스 타입 List 로 해두는 게 더 유연한 코드를 작성하는 것 이다.
         */
        ...
        /* 필기. arrayList 의 크기는 size() 로 확인한다.
        ...
        /* 필기.
            Iterator 란?
            Collection 인터페이스의 interator() 메소드를 이용해서 인스턴스를 생성 할 수 있다.
            hasNext() : 다음요소를 가지고 있으면 true, 더이상 요소가 없으면 false 를 반환
            next() : 다음요소(값)를 반환
         */
        Iterator<String> dIter = ((LinkedList<String>)stringList).descendingIterator();
        /*필기, 역순으로 정렬된 결과를 저장하기 위해 새로운 ArrayList 를 만들어서 저장 */
